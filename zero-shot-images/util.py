...
class DATA_LOADER(object):
    ...
    def read_matdataset(self, opt):
        ...
        if opt.awa_encoding:
            custom_matcontent = sio.loadmat(opt.dataroot + "/" + opt.dataset + "/" + opt.awa_encoding +".mat")
            print('use custom attribute')
        ...
        if opt.awa_encoding:
            self.attribute = torch.from_numpy(custom_matcontent['att'].T).float()
            print('transform custom attribute')
        else:
